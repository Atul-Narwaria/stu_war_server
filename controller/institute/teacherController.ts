...
import { createBulkTeacher, createTeacherWithAddress } from "../../model/teacher/teacher";
export const institutecreateTeacher = async (data: {
    firstname: string,
    lastname: string,
    email: string,
    phone: string,
...
export const createBulkTeacherController = async (data: any, instid: string) => {
